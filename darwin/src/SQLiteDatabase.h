...
//
template <class DATABASE_IMAGE_TYPE>
char* SQLiteDatabase<DATABASE_IMAGE_TYPE>::handleNull(char *in) {
...
//
template <class DATABASE_IMAGE_TYPE>
int SQLiteDatabase<DATABASE_IMAGE_TYPE>::generateUniqueInt() {
...
//
template <class DATABASE_IMAGE_TYPE>
string SQLiteDatabase<DATABASE_IMAGE_TYPE>::escapeString(string str) {
	string buffer = str;
...
//
template <class DATABASE_IMAGE_TYPE>
string SQLiteDatabase<DATABASE_IMAGE_TYPE>::stripEscape(string str) {
	string buffer = str;
...
//
template <class DATABASE_IMAGE_TYPE>
int SQLiteDatabase<DATABASE_IMAGE_TYPE>::callbackIndividuals(void *individuals, int argc, char **argv, char **azColName) {
	int i;
	DBIndividual temp;
...
//
template <class DATABASE_IMAGE_TYPE>
int SQLiteDatabase<DATABASE_IMAGE_TYPE>::callbackDamageCategories(void *damagecategories, int argc, char **argv, char **azColName) {
	int i;
...
//
template <class DATABASE_IMAGE_TYPE>
int SQLiteDatabase<DATABASE_IMAGE_TYPE>::callbackDBInfo(void *dbinfo, int argc, char **argv, char **azColName) {
	int i;
	DBInfo temp;
...
//
template <class DATABASE_IMAGE_TYPE>
int SQLiteDatabase<DATABASE_IMAGE_TYPE>::callbackImageModifications(void *imagemods, int argc, char **argv, char **azColName) {
	int i;
...
//
template <class DATABASE_IMAGE_TYPE>
int SQLiteDatabase<DATABASE_IMAGE_TYPE>::callbackImages(void *images, int argc, char **argv, char **azColName) {
	int i;
	DBImage temp;
...
//
template <class DATABASE_IMAGE_TYPE>
int SQLiteDatabase<DATABASE_IMAGE_TYPE>::callbackOutlines(void *outlines, int argc, char **argv, char **azColName) {
	int i;
	DBOutline temp;
...
//
template <class DATABASE_IMAGE_TYPE>
int SQLiteDatabase<DATABASE_IMAGE_TYPE>::callbackPoints(void *points, int argc, char **argv, char **azColName) {
	int i;
	DBPoint temp;
...
//
template <class DATABASE_IMAGE_TYPE>
int SQLiteDatabase<DATABASE_IMAGE_TYPE>::callbackThumbnails(void *thumbnails, int argc, char **argv, char **azColName) {
	int i;
	DBThumbnail temp;
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::setSyncMode(int mode) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::beginTransaction() {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::commitTransaction() {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectAllDamageCategories(std::list<DBDamageCategory> *damagecategories) {
...
//
template <class DATABASE_IMAGE_TYPE> 
DBDamageCategory SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectDamageCategoryByName(std::string name) {
...
//
template <class DATABASE_IMAGE_TYPE> 
DBDamageCategory SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectDamageCategoryByID(int id) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectAllIndividuals(std::list<DBIndividual> *individuals) {

	rc = sqlite3_exec(db, "SELECT * FROM Individuals;", SQLiteDatabase<DATABASE_IMAGE_TYPE>::callbackIndividuals, individuals, &zErrMsg);
...
//
template <class DATABASE_IMAGE_TYPE>
DBIndividual SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectIndividualByID(int id) {
	...
	rc = sqlite3_exec(db, sql.str().c_str(), SQLiteDatabase<DATABASE_IMAGE_TYPE>::callbackIndividuals, &individuals, &zErrMsg);
...
//
template <class DATABASE_IMAGE_TYPE>
DBIndividual SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectIndividualByName(std::string name) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectIndividualsByFkDamageCategoryID(std::list<DBIndividual> *individuals, int fkdamagecategoryid) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectAllDBInfo(std::list<DBInfo> *dbinfo) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectAllImageModifications(std::list<DBImageModification> *imagemodifications) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectImageModificationsByFkImageID(std::list<DBImageModification> *imagemodifications, int fkimageid) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectAllImages(std::list<DBImage> *images) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectImagesByFkIndividualID(std::list<DBImage> *images, int fkindividualid) {
...
//
template <class DATABASE_IMAGE_TYPE>
DBImage SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectImageByFkIndividualID(int fkindividualid) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectAllOutlines(std::list<DBOutline> *outlines) {
...
//
template <class DATABASE_IMAGE_TYPE>
DBOutline SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectOutlineByFkIndividualID(int fkindividualid) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectAllPoints(std::list<DBPoint> *points) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectPointsByFkOutlineID(std::list<DBPoint> *points, int fkoutlineid) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectAllThumbnails(std::list<DBThumbnail> *thumbnails) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectThumbnailsByFkImageID(std::list<DBThumbnail> *thumbnails, int fkimageid) {
...
//
template <class DATABASE_IMAGE_TYPE>
DBThumbnail SQLiteDatabase<DATABASE_IMAGE_TYPE>::selectThumbnailByFkImageID(int fkimageid) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::insertIndividual(DBIndividual *individual) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::insertDamageCategory(DBDamageCategory *damagecategory) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::insertPoint(DBPoint *point) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::insertDBInfo(DBInfo *dbinfo) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::insertOutline(DBOutline *outline) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::insertImage(DBImage *image) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::insertImageModification(DBImageModification *imagemod) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::insertThumbnail(DBThumbnail *thumbnail) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::insertPoints(std::list<DBPoint>* points) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::insertImageModifications(std::list<DBImageModification>* imagemods) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::updateOutline(DBOutline *outline) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::updateDamageCategory(DBDamageCategory *damagecategory) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::updateIndividual(DBIndividual *individual) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::updateImage(DBImage *image) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::updateImageModification(DBImageModification *imagemod) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::updateThumbnail(DBThumbnail *thumbnail) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::updateDBInfo(DBInfo *dbinfo) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::deletePoints(int fkOutlineID) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::deleteOutlineByFkIndividualID(int fkIndividualID) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::deleteOutlineByID(int id) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::deleteIndividual(int id) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::deleteDamageCategory(int id) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::deleteImage(int id) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::deleteImageModification(int id) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::deleteThumbnail(int id) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::deleteThumbnailByFkImageID(int id) {
...
//
template <class DATABASE_IMAGE_TYPE>
unsigned long SQLiteDatabase<DATABASE_IMAGE_TYPE>::add(DatabaseFin<DATABASE_IMAGE_TYPE> *fin) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::update(DatabaseFin<DATABASE_IMAGE_TYPE> *fin) {
	DBIndividual individual;
	DBImage image;
	DBOutline outline;
	DBThumbnail thumbnail;
...
//
template <class DATABASE_IMAGE_TYPE>
DatabaseFin<DATABASE_IMAGE_TYPE>* SQLiteDatabase<DATABASE_IMAGE_TYPE>::getFin(int id) {
...
//
template <class DATABASE_IMAGE_TYPE>
std::list< DatabaseFin<DATABASE_IMAGE_TYPE>* >* SQLiteDatabase<DATABASE_IMAGE_TYPE>::getAllFins(void) {
...
//
template <class DATABASE_IMAGE_TYPE>
DatabaseFin<DATABASE_IMAGE_TYPE>* SQLiteDatabase<DATABASE_IMAGE_TYPE>::getItem(unsigned pos) {
...
//
template <class DATABASE_IMAGE_TYPE>
DatabaseFin<DATABASE_IMAGE_TYPE>* SQLiteDatabase<DATABASE_IMAGE_TYPE>::getItemByName(std::string name) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::Delete(DatabaseFin<DATABASE_IMAGE_TYPE> *fin) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::sortLists() {
...
//
template <class DATABASE_IMAGE_TYPE>
unsigned SQLiteDatabase<DATABASE_IMAGE_TYPE>::size() const
{
...
//
template <class DATABASE_IMAGE_TYPE>
unsigned SQLiteDatabase<DATABASE_IMAGE_TYPE>::sizeAbsolute() const
{
...
//
template <class DATABASE_IMAGE_TYPE>
bool SQLiteDatabase<DATABASE_IMAGE_TYPE>::isEmpty() const
{
...
//
template <class DATABASE_IMAGE_TYPE>
typename SQLiteDatabase<DATABASE_IMAGE_TYPE>::db_status_t SQLiteDatabase<DATABASE_IMAGE_TYPE>::status() const
{
	return mDBStatus;
}
...
//
template <class DATABASE_IMAGE_TYPE>
db_sort_t SQLiteDatabase<DATABASE_IMAGE_TYPE>::currentSort()
{
	return mCurrentSort;
}
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::sort(db_sort_t sortBy)
{
	mCurrentSort = sortBy;
}
...
//
template <class DATABASE_IMAGE_TYPE>
int SQLiteDatabase<DATABASE_IMAGE_TYPE>::getIDListPosit(std::string id)
{
...
//
template <class DATABASE_IMAGE_TYPE>
DatabaseFin<DATABASE_IMAGE_TYPE>* SQLiteDatabase<DATABASE_IMAGE_TYPE>::getItemAbsolute(unsigned pos) {
...
//
template <class DATABASE_IMAGE_TYPE>
string SQLiteDatabase<DATABASE_IMAGE_TYPE>::getItemEntryFromList(db_sort_t whichList, unsigned pos) {	
...
//
template <class DATABASE_IMAGE_TYPE>
int SQLiteDatabase<DATABASE_IMAGE_TYPE>::getItemListPosFromOffset(db_sort_t whichList, string item) {
...
//
template <class DATABASE_IMAGE_TYPE>
DatabaseFin<DATABASE_IMAGE_TYPE>* SQLiteDatabase<DATABASE_IMAGE_TYPE>::getItem(unsigned pos, std::vector<std::string> *theList) {	
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::loadLists() {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::opendb(const char *filename) {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::closedb() {
...
//
template <class DATABASE_IMAGE_TYPE>
void SQLiteDatabase<DATABASE_IMAGE_TYPE>::createEmptyDatabase(Options *o) {
...
//
template <class DATABASE_IMAGE_TYPE>
string SQLiteDatabase<DATABASE_IMAGE_TYPE>::getFilename() {
...
//
template <class DATABASE_IMAGE_TYPE>
SQLiteDatabase<DATABASE_IMAGE_TYPE>::SQLiteDatabase(Options *o, bool createEmptyDB) {
...
//
template <class DATABASE_IMAGE_TYPE>
SQLiteDatabase<DATABASE_IMAGE_TYPE>::~SQLiteDatabase() {
...
//
template <class DATABASE_IMAGE_TYPE>
bool SQLiteDatabase<DATABASE_IMAGE_TYPE>::closeStream()
{
	closedb();
	return true;
}
...
//
template <class DATABASE_IMAGE_TYPE>
bool SQLiteDatabase<DATABASE_IMAGE_TYPE>::openStream()
{
	opendb(mFilename.c_str());
	return true;
}
